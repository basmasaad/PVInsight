...
const DataNormalization = () => {
    ...
    return (
        <div className="p-4 border-1 border-dashed border-emerald-600 rounded-2xl">
            <h2 className="text-xl font-bold mb-4 text-green-600">Data Normalization</h2>
            <div className="mb-4 mr-4">
                <label htmlFor="field-select" className="mr-2">Select Columns to Normalize</label>
                <select onChange={handleColumnSelect} className="border border-gray-300 rounded-md pr-2 pr-8 focus:outline-none focus:ring focus:border-blue-500">
